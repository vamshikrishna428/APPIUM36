...
public class ScroolDemo2 {
	...
	//	driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector().resourceId(\"android:id/list\")).getChildByDescription(new UiSelector().className(\"android.widget.TextView\"),\"WebView\")").click();
